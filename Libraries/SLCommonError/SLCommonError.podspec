Pod::Spec.new do |s|
    s.name = 'SLCommonError'
    s.version = '0.0.1'
    s.summary = 'This module contains all commons errors.'
    s.description = <<-DESC
    This module should have all commons errors supports.
    DESC
    ...
    s.subspec 'Release' do |release|
        ...
        release.resources = 'Sources/Resources/**/*.{json,ttf,otf,png,strings,xcassets,pdf}'
