Pod::Spec.new do |s|
    s.name = 'SLStorage'
    s.version = '0.0.1'
    s.summary = 'This module contains all classes to storage.'
    s.description = <<-DESC
    This module should have all classes to storage supports.
    DESC
    ...
    s.subspec 'Release' do |release|
        ...
        release.dependency 'SLStorageInterface'
        release.dependency 'KeychainSwift'
