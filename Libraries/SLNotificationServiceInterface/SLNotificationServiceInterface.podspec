Pod::Spec.new do |s|
    s.name = 'SLNotificationServiceInterface'
    s.version = '0.0.1'
    s.summary = 'This module contains notification service interface.'
    s.description = <<-DESC
    This module should have all interfaces to notification service.
    DESC
