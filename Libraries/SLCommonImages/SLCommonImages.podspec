Pod::Spec.new do |s|
    s.name = 'SLCommonImages'
    s.version = '0.0.1'
    s.summary = 'This module contains all commons images.'
    s.description = <<-DESC
    This module should have all commons images supports.
    DESC
    ...
    s.subspec 'Release' do |release|
        ...
        release.resources = 'Sources/Assets/**/*.{json,ttf,otf,png,strings,xcassets,pdf}'
